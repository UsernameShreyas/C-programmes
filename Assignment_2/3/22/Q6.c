/*
Q6) KLE Technological University is a well know university for its academic excellence and Innovations.
...
struct kle_tech         //Defining Variable
{
    int ranks;      //Defining Variable
    int sno;        //Defining Variable

}
st[100];
void read_rankings(struct kle_tech [] , int);       //Function Call
void ascending_ranks(struct kle_tech [] ,int );     //Function Call
void display_highest_lowest(struct kle_tech[], int );       //Function Call
...
void read_rankings(struct kle_tech st[],int b)      //Function Definition
{
    int i,j;
    for(i=0,j=1;i<b;i++,j++)
    {
...
void ascending_ranks(struct kle_tech st[] , int b)      //Function Definition
{
    int i,j;
...
void display_highest_lowest(struct kle_tech st[],int b)     //Function Definition
{
    int i;
    int lowest, highest;
    int lno,hno;

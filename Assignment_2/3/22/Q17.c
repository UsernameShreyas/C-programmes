/*
Q17)	Read the 2 sets(2 arrays) of numbers with same size n.
...
void exchange_arrays(int [],int [],int );       //Function Call
...
void print_array(int a[],int n)     //Defining a function
{
    int i;
    for(i=0;i<n;i++)
    {
...
void exchange_arrays(int a[],int b[],int n)     //Defining a function
{
    int i;
    int temp[n];
    for(i=0;i<n;i++)

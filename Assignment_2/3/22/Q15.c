/*Q15)	Calculate the minimum number of platforms required for a
...
void read_arr(int arr[],int n)      //Defining Function
{
    int i;
...
void read_dep(int dep[],int n)       //Defining Function
{
    int i;
...
int findPlatform(int arr[], int dep[], int n)       //Defining Function
{

/*  Q2)	Read an array of n numbers. Input the number from keyboard (consider it as a key number)
...
void find_key(int [] , int);        //Function Call
...
void read_array(int a[], int b)     //Function Definition
{
	int i;
...
void print_array(int a[], int b)        //Function Definition
{
	int i;
	for(i=0;i<b;i++)
      {
...
void find_key(int a[] , int b)          //Function Definition
{
    int i,j,key;
    j=0;

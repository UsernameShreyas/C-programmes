/*Q8)    A middle class family would always like to spend the money wisely, because of their
...
struct expend           //Defining Variable
{
    int months;         //Defining Variable
    int expenditure;    //Defining Variable
}
exp[12];

void read_expenditure(struct expend []);        //Function Call
void spent_more(struct expend []);              //Function Call
void spent_less(struct expend []);              //Function Call
void spent_ab_35(struct expend []);             //Function Call
void average_expenditure(struct expend []);     //Function Call
...
void read_expenditure(struct expend exp[])      //Defining Function 
{
    int i,j;
...
void spent_more(struct expend exp[])            //Defining Function
{
    int i,mno;
    int highest;
...
void spent_less(struct expend exp[])            //Defining Function
{
    int i,mno;
    int lowest;
...
void spent_ab_35(struct expend exp[])           //Defining Function
{
    int i,mno;
    mno = 0;
...
void average_expenditure(struct expend exp[])   //Defining Function
{
    int i,sum;
    sum = 0;
    float average = 0;

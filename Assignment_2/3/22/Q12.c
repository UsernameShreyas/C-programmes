/*Q12)	Write a modular c program to perform the following:
        a) Read 1D array
        b) Display 1D array
...
void find_max_dig(int[],int);      //Function Call 
...
void print_array(int a[],int b)     //Defining Function
{
    int i;
    printf("{");
    for(i=0;i<b;i++)
...
void find_max_dig(int a[],int b)    //Defining Function
{
    int i,s;

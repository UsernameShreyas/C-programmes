/*Q11)  Godrej constructed a new Apartment with N flats, in Hubballi.
...
struct apartment
{
    int flatno;         //Defining Variable
    int unit;           //Defining Variable
}ap[100];

void read_unit(struct apartment[],int );        //Function Call
void calc_bill(struct apartment[],int );        //Function Call
...
void read_unit(struct apartment ap[],int b)      //Defining Function
{
    int i,j;
    for(i=0,j=1;i<b;i++,j++)
    {
...
void calc_bill(struct apartment ap[],int b)     //Defining Function
{
    int i;
    float total_flat;
    total_flat = 0;
